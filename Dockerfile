...
RUN apk add --no-cache ca-certificates wget unzip && \
    ...
    wget -P /tmp/ https://github.com/anopem/TwitchDropsMiner/releases/download/dev-build/Twitch.Drops.Miner.Linux.musl.PyInstaller-${ARCH_SUFFIX}.zip && \
...
ENV TDM_VERSION_TAG=16.dev.0fef327
